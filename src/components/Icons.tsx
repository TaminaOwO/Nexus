...
// Search Icon - 搜尋放大鏡
export const SearchIcon = ({ size = 20, className = "", color = "currentColor" }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
// Book Open Icon - 記錄交易
export const BookOpenIcon = ({ size = 20, className = "", color = "currentColor" }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const TrendingUpIcon = ({ size = 20, className = "", color = "currentColor" }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
// Tag Icon - 子策略標籤
export const TagIcon = ({ size = 20, className = "", color = "currentColor" }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
// Dollar Sign Icon - 價格
export const DollarSignIcon = ({ size = 20, className = "", color = "currentColor" }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
// Target Icon - 目標價
export const TargetIcon = ({ size = 20, className = "", color = "currentColor" }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
// Stop Circle Icon - 停損
export const StopCircleIcon = ({ size = 20, className = "", color = "currentColor" }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const LoaderIcon = ({ size = 20, className = "", color = "currentColor" }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const CheckCircleIcon = ({ size = 20, className = "", color = "currentColor" }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
// X Circle Icon - 禁止/錯誤
export const XCircleIcon = ({ size = 20, className = "", color = "currentColor" }: IconProps) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
