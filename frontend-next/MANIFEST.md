...
- **Coverage**: nexus-backend fetchers, HealthCycleCard, SkincareCard, LifePage integration, date attribution, Sidebar, BFF catlab route (cache + parsing), CatLabPostCard, CatLabSkeleton, CatLabError, CatRecordTimeline, MarketingPage integration
